...
const translations = {
  en: {
    ...
    the_brand: 'The Brand',
    story_text: 'Eye Manga was born out of a deep passion for Japanese art and storytelling. We started as a small group of collectors in Georgia who wanted to make high-quality manga accessible to everyone for affordable prices.',
    ...
    brand_text: 'Eye Manga represents the "eye" for detail and quality. From the crisp printing of our manga to the premium feel of our service, we ensure every item meets the highest standards of the fan community.',
    how_to_order: 'How to Order',
    step_1: '1. Browse and Select',
    step_1_text: 'Explore our catalog and add your favorite manga to the cart.',
  ...
  ka: {
    ...
    the_story: 'ჩვენს შესახებ',
    the_vision: 'ხედვა',
    the_brand: 'ბრენდი',
    story_text: 'Eye Manga დაიბადა იაპონური ხელოვნებისა და თხრობისადმი დიდი სიყვარულით. ჩვენ დავიწყეთ როგორც კოლექციონერთა მცირე ჯგუფმა საქართველოში, რომლებსაც სურდათ მაღალი ხარისხის მანგა ყველასთვის ხელმისაწვდომი გაეხადათ იაფად.',
    ...
    brand_text: 'Eye Manga ნიშნავს ხარისხსა და დეტალებზე ორიენტირებულობას. ჩვენი მანგის მკაფიო ბეჭდვიდან დაწყებული ჩვენი სერვისის პრემიუმ ხარისხით დასრულებული, ჩვენ ვზრუნავთ, რომ თითოეული ნივთი აკმაყოფილებდეს ფან-საზოგადოების უმაღლეს სტანდარტებს.',
    how_to_order: 'როგორ შევუკვეთოთ',
    step_1: '1. აარჩიეთ პროდუქცია',
    step_1_text: 'დაათვალიერეთ ჩვენი კატალოგი და დაამატეთ თქვენი ფავორიტი მანგა კალათაში.',
