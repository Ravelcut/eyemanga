...
const translations = {
  en: {
    ...
    instruction: 'After copying, click below and paste the details in a message to @keepittoxxic',
  ...
  ka: {
    ...
    instruction: 'კოპირების შემდეგ დააჭირეთ ქვემოთ და ჩასვით (paste) მონაცემები @keepittoxxic-თან შეტყობინებაში',
